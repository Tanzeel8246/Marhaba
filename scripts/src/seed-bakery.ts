...
import { Pool } from "pg";
import { categories, products, banners } from "../../lib/db/src/schema";
...
async function seed() {
  ...
  console.log("Created categories:", [cakes, cookies, pastries, breads].map(c => c.name));
  ...
  await db.insert(products).values([
    {
      ...
      basePrice: "48.00",
      categoryId: cakes.id,
      imageUrls: ["https://images.unsplash.com/photo-1558636508-e0db3814bd1d?w=600&q=80"],
      variants: [
      ...
      addons: [{ name: "Gold Drip", price: 8 }, { name: "Edible Flowers", price: 12 }, { name: "Fondant Topper", price: 15 }],
    ...
    },
    {
      ...
      basePrice: "55.00",
      categoryId: cakes.id,
      imageUrls: ["https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=600&q=80"],
      variants: [
      ...
      addons: [{ name: "Chocolate Shards", price: 6 }, { name: "Raspberry Coulis", price: 5 }],
      allowCustomMessage: true,
      isVisible: true,
      isAvailable: true,
    },
    {
      ...
      basePrice: "42.00",
      categoryId: cakes.id,
      imageUrls: ["https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=600&q=80"],
      variants: [
    ...
    },
    {
      ...
      imageUrls: ["https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=600&q=80"],
      variants: [
    ...
    },
    {
      ...
      basePrice: "38.00",
      categoryId: cookies.id,
      imageUrls: ["https://images.unsplash.com/photo-1569864358642-9d1684040f43?w=600&q=80"],
      variants: [
    ...
    },
    {
      ...
      imageUrls: ["https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=600&q=80"],
      variants: [
    ...
    },
    {
      ...
      imageUrls: ["https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80"],
      addons: [{ name: "Scoring Design", price: 3 }],
      allowCustomMessage: false,
      isVisible: true,
      isAvailable: true,
    },
    {
      ...
      basePrice: "52.00",
      categoryId: cakes.id,
      imageUrls: ["https://images.unsplash.com/photo-1586788680434-30d324b2d46f?w=600&q=80"],
      variants: [
  ...
  console.log("✅ Seed complete! Created products and banners.");
  await pool.end();
}
