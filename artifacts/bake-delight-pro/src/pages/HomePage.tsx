      ...
      <div className="flex flex-col gap-12 sm:gap-20 pb-20">
        ...
        <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:h-[600px]">
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="col-span-2 md:row-span-2 h-[250px] md:h-full neu-pressed rounded-[2.5rem] overflow-hidden p-2">
            ...
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="neu-pressed rounded-[2rem] overflow-hidden p-2 h-[120px] md:h-full">
            ...
            <motion.div variants={itemVariants} className="col-span-2 h-[150px] md:h-full md:aspect-video xl:aspect-square neu-flat p-4 rounded-[2rem]">
