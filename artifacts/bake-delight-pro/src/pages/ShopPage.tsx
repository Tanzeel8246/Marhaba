    ...
    <Link href={`/products/${product.id}`}>
      <Card className="overflow-hidden group cursor-pointer transition-all duration-200 hover:shadow-lg hover:-translate-y-1 h-full">
        <div className="aspect-square overflow-hidden bg-muted relative">
          ...
          {!product.isAvailable && (
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
              <Badge variant="secondary">دستیاب نہیں</Badge>
            </div>
          )}
          {product.category && (
        ...
        <CardContent className="p-4">
          ...
          <p className="font-bold text-primary">{formatCurrency(Number(product.basePrice))} سے</p>
        </CardContent>
      </Card>
    </Link>
  );
  ...
  return (
    <StorefrontLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-serif font-bold mb-2" dir="rtl">ہماری بیکری</h1>
          <p className="text-muted-foreground" dir="rtl">تازہ اور لذیذ آئٹمز — محبت سے تیار کردہ</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-52 shrink-0 space-y-6">
            ...
            <div>
              <h3 className="text-sm font-semibold mb-3 uppercase tracking-widest text-muted-foreground" dir="rtl">اقسام</h3>
